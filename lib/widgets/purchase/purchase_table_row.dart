...
class PurchaseTableRow extends StatelessWidget {
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isExpiringSoon
              ? const Color(0xFFFF8A65) // Deep Orange accent for warning
              : const Color(0xFFE5E7EB), // Neutral Gray border
          width: 1.5,
        ),
      ),
      child: Material(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            // The main Row now uses a more flexible layout strategy.
            child: Row(
              children: [
                // KEY CHANGE 1:
                // This is the only Expanded widget. It will greedily take up all
                // the remaining space after the other columns have sized themselves.
                Expanded(
                ...
                // KEY CHANGE 2:
                // These columns are NOT Expanded. They will take up only the
                // horizontal space their content requires.
  ...
  /// Builds the Purchase and Expiry Date column.
  Widget _buildDateInfo(bool isExpiringSoon) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 4),
        // Use Opacity to reserve space even when not visible, preventing layout jumps.
        Opacity(
